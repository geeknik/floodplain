...
class sfp_gravatar(SpiderFootPlugin):
    ...
    def query(self, qry):
        # MD5 is mandated by the Gravatar API (not a security control).
        email_hash = hashlib.md5(qry.encode('utf-8', errors='replace').lower(), usedforsecurity=False).hexdigest()  # noqa: DUO130
        output = 'json'
